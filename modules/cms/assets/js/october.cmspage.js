...
+function ($) { "use strict";
    ...
    CmsPage.prototype.onInitTab = function(ev, data) {
        ...
        var $collapseIcon = $('<a href="js:;" class="tab-collapse-icon tabless"><i class="icon-chevron-up"></i></a>'),
        ...
        var $primaryCollapseIcon = $('<a href="js:;" class="tab-collapse-icon primary"><i class="icon-chevron-down"></i></a>'),
