 ...
 *
 * This removes the shizuka theme and plugin. A great way to start a fresh project!
 *
...
class OctoberFresh extends Command
{
     ...
     */
    protected $description = 'Removes the shizuka theme and plugin.';
    ...
    public function fire()
    {
        ...
        $demoThemePath = themes_path().'/shizuka';
