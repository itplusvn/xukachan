...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/home.html', $loader->getSourceContext('errors/home.html')->getName());
        $this->assertEquals(realpath($path.'/errors/home.html'), realpath($loader->getSourceContext('errors/home.html')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('home.html')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/home.html')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/home.html')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        $namedSource = $loader->getSourceContext('@named/home.html')->getCode();
